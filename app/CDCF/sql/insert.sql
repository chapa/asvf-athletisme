	-- users(id, pseudo, pass, mail, displayMail, name, firstName, birth, created, status)
INSERT INTO users VALUES(DEFAULT, 'restreint', '4f940dae3892f41434f7977bfd95b4752eb1e1b5', 'restreint@restreint.res', 'pri', 'Dupont', 'Bertrant', '10/03/1963', DEFAULT, DEFAULT);
INSERT INTO users VALUES(DEFAULT, 'adherent', 'd9618f6739a2c91b4204c2c6a666c2be3bfca560', 'adherent@adherent.adh', 'pro', 'Delacourt', 'Gérald', '24/08/1969', DEFAULT, 'Adhérent');
INSERT INTO users VALUES(DEFAULT, 'redacteur', '06c1daf36e4acd92a2b784f73ff909d121ee9b13', 'redacteur@redacteur.red', 'pub', 'Delalong', 'Augustin', '15/12/1989', DEFAULT, 'Rédacteur');
INSERT INTO users VALUES(DEFAULT, 'admin', '88310595928201b961247f4736b09b161e2d023b', 'admin@admin.adm', 'pub', 'Lebon', 'Jean-Bono', '08/04/1975', DEFAULT, 'Administrateur');
...
INSERT INTO content_categories VALUES(DEFAULT, 'Compétitions');
	...
	-- contents(id, name, content, created, published, content_type_id, content_category_id, user_id)
